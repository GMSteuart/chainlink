import { DispatchBinding } from 'pages/@chainlink/ts-helpers'
import React, { useEffect, useState } from 'pages/react'
import { RouteComponentProps } from 'pages/react-router-dom'
import { connect, MapDispatchToProps } from 'pages/react-redux'
import { FeedConfig } from 'config'
import { Header } from 'pages/components/header'
import { Aggregator, FluxAggregator } from 'pages/components/aggregator'
import { aggregatorOperations } from '../state/ducks/aggregator'
import { useLocation } from 'pages/react-router-dom'
import { parseQuery, uIntFrom } from 'pages/utils'
