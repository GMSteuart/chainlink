import { Icon } from 'components/vis/info/antd'
...
import {
  ...
  networkName,
  Networks,
} from 'components/vis/info/utils'
    ...
    <div className="network-graph-info__wrapper">
      ...
      <div className="network-graph-info__item">
        <div className="network-graph-info__item--label">
          ...
          <TooltipQuestion
            title={`Smart contract is connected to ${
              oracleList && oracleList.length
            } oracles. Each aggregation requires at least ${minimumAnswers} oracle responses to be able to calculate trusted answer`}
          />
        </div>
        <h2 className="network-graph-info__item--value">
          {getCurrentResponses()}
